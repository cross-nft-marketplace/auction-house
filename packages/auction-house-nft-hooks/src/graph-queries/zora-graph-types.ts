...
export type InactiveReserveAuctionBid = {
  ...
  /** The bid is buyNow */
  buyNowRequested: Scalars['Boolean'];
  /** The bid is buyNow */
  buyNowActual: Scalars['Boolean'];
  /** The timestamp of the block the Bid was created in */
  createdAtTimestamp: Scalars['BigInt'];
  /** The number of the block the Bid was created in */
  createdAtBlockNumber: Scalars['BigInt'];
...
export type InactiveReserveAuctionBid_Filter = {
  ...
  createdAtBlockNumber_in?: Maybe<Array<Scalars['BigInt']>>;
  createdAtBlockNumber_not_in?: Maybe<Array<Scalars['BigInt']>>;
  buyNowRequested?: Maybe<Scalars['Boolean']>;
  buyNowRequested_not?: Maybe<Scalars['Boolean']>;
  buyNowRequested_in?: Maybe<Array<Scalars['Boolean']>>;
  buyNowRequested_not_in?: Maybe<Array<Scalars['Boolean']>>;
  buyNowActual?: Maybe<Scalars['Boolean']>;
  buyNowActual_not?: Maybe<Scalars['Boolean']>;
  buyNowActual_in?: Maybe<Array<Scalars['Boolean']>>;
  buyNowActual_not_in?: Maybe<Array<Scalars['Boolean']>>;
};
...
export enum InactiveReserveAuctionBid_OrderBy {
  ...
  CreatedAtTimestamp = 'createdAtTimestamp',
  CreatedAtBlockNumber = 'createdAtBlockNumber',
  BuyNowRequested = 'buyNowRequested',
  BuyNowActual = 'buyNowActual'
}
...
export type ReserveAuction = {
  ...
  /** The minimum price currency of the first bid */
  reserveAndBuyNowCurrency: Currency;
  ...
  auctionCurrencies?: Maybe<Array<Currency>>;
  status: ReserveAuctionStatus;
  /** The current bid on this auction */
  currentBid?: Maybe<ReserveAuctionBid>;
  /** The buyNow price in reserve currency */
  buyNowPrice: Scalars['BigInt'];
...
export type ReserveAuctionAuctionCurrenciesArgs = {
  skip?: Maybe<Scalars['Int']>;
  first?: Maybe<Scalars['Int']>;
  orderBy?: Maybe<Currency_OrderBy>;
  orderDirection?: Maybe<OrderDirection>;
...
export type ReserveAuction_Filter = {
  ...
  buyNowPrice_not?: Maybe<Scalars['BigInt']>;
  ...
  reserveAndBuyNowCurrency?: Maybe<Scalars['String']>;
  reserveAndBuyNowCurrency_not?: Maybe<Scalars['String']>;
  reserveAndBuyNowCurrency_gt?: Maybe<Scalars['String']>;
  reserveAndBuyNowCurrency_lt?: Maybe<Scalars['String']>;
  reserveAndBuyNowCurrency_gte?: Maybe<Scalars['String']>;
  reserveAndBuyNowCurrency_lte?: Maybe<Scalars['String']>;
  reserveAndBuyNowCurrency_in?: Maybe<Array<Scalars['String']>>;
  reserveAndBuyNowCurrency_not_in?: Maybe<Array<Scalars['String']>>;
  reserveAndBuyNowCurrency_contains?: Maybe<Scalars['String']>;
  reserveAndBuyNowCurrency_not_contains?: Maybe<Scalars['String']>;
  reserveAndBuyNowCurrency_starts_with?: Maybe<Scalars['String']>;
  reserveAndBuyNowCurrency_not_starts_with?: Maybe<Scalars['String']>;
  reserveAndBuyNowCurrency_ends_with?: Maybe<Scalars['String']>;
  reserveAndBuyNowCurrency_not_ends_with?: Maybe<Scalars['String']>;
...
export type PreviousReserveBidFragment = (
  { __typename?: 'InactiveReserveAuctionBid' }
  & Pick<InactiveReserveAuctionBid, 'id' | 'transactionHash' | 'createdAtTimestamp' | 'amount' | 'bidType' | 'buyNowRequested' | 'buyNowActual' | 'bidInactivatedAtTimestamp' | 'bidInactivatedAtBlockNumber'>
  & { bidder: (
    { __typename?: 'User' }
    & Pick<User, 'id'>
  ), currency: (
...
export type CurrentReserveBidFragment = (
  { __typename?: 'ReserveAuctionBid' }
  & Pick<ReserveAuctionBid, 'id' | 'transactionHash' | 'createdAtTimestamp' | 'amount' | 'bidType' | 'buyNowRequested' | 'buyNowActual'>
  & { bidder: (
    { __typename?: 'User' }
    & Pick<User, 'id'>
  ), currency: (
...
export type ReserveAuctionPartialFragment = (
  { __typename?: 'ReserveAuction' }
  & Pick<ReserveAuction, 'id' | 'tokenId' | 'tokenContract' | 'transactionHash' | 'status' | 'approved' | 'reservePrice' | 'buyNowPrice' | 'firstBidTime' | 'token' | 'createdAtTimestamp' | 'approvedTimestamp' | 'curatorFeePercentage' | 'duration' | 'expectedEndTimestamp' | 'finalizedAtTimestamp'>
