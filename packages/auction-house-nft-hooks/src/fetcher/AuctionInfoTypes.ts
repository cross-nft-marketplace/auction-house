...
export type PastReserveBid = Omit<PreviousReserveBidFragment, 'currency' | 'amount'> & 
  BidPricingInfo;

export type CurrentReserveBid = Omit<CurrentReserveBidFragment, 'currency' | 'amount'> &
  BidPricingInfo;
