...
export function createReserveAuction(
  ...
  duration: BigInt,
  reservePrice: BigInt,
  reservePriceCurrency: Currency,
  curatorFeePercentage: i32,
  auctionCurrencies: Currency[],
  createdAtTimestamp: BigInt,
  createdAtBlockNumber: BigInt,
  tokenOwner: User,
  curator: User,
  ...
  reserveAuction.reserveAndBuyNowCurrency = reservePriceCurrency.id
  ...
  reserveAuction.auctionCurrencies = auctionCurrencies.map<string>(cur => cur.id)
  ...
  reserveAuction.buyNowPrice = buyNowPrice
...
export function createReserveAuctionBid(
  ...
  bid.createdAtTimestamp = createdAtTimestamp
  bid.createdAtBlockNumber = createdAtBlockNumber
  bid.buyNowRequested = buyNowRequested,
  bid.buyNowActual = buyNowActual
...
export function handleBidReplaced(auction: ReserveAuction, timestamp: BigInt, blockNumber: BigInt, winningBid: boolean = false): void {
  ...
  inactiveBid.currency = activeBid.currency
  ...
  log.info('setting bid buyNowRequested', [])
  inactiveBid.buyNowRequested = activeBid.buyNowRequested
  log.info('setting bid buyNowActual', [])
  inactiveBid.buyNowActual = activeBid.buyNowActual
