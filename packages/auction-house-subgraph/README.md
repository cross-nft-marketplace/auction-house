# cross-nft-marketplace � Auction House Subgraph

The cross-nft-marketplace Auction House Subgraph based on [Zora V1 Subgraph](https://github.com/ourzora/zora-v1-subgraph).

The cross-nft-marketplace Auction House Subgraph, is a public subgraph implementation of the Graph Protocol for the cross-nft-marketplace Auction House. It also provides an easy to use GraphQL interface for developers to imply query data about the cross-nft-marketplace Auction House.

The Graph offers a hosted service for public interaction with the cross-nft-marketplace Auction House, but you can also run your own graph-node with a cross-nft-marketplace Auction House Subgraph by following the Graph's [documentation](https://thegraph.com/docs/network#indexing) and joining their Indexer discord.

Networks:
- [Rinkeby](https://thegraph.com/explorer/subgraph/cross-nft-marketplace/auction-house-rinkeby)
- [Mainnet](https://thegraph.com/explorer/subgraph/cross-nft-marketplace/auction-house-mainnet)
...
References:
- [The Graph](https://thegraph.com/explorer/subgraph/)
